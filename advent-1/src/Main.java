    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (s.hasNextLine()) {
                ...
                while (currentLine.contains("one") || currentLine.contains("two") ||
                        currentLine.contains("three") || currentLine.contains("four") ||
                        currentLine.contains("five") || currentLine.contains("six") ||
                        currentLine.contains("seven") || currentLine.contains("eight") ||
                        currentLine.contains("nine")) {
                ...
                String replace = currentLine.replaceAll("\\D+", "");
                int first = Integer.parseInt(replace.charAt(0) + "0");
                int last = Integer.parseInt(replace.substring(replace.length() - 1));
